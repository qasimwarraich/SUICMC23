...
{#if showInformation}
	<div transition:slide>
		<h2 class="text-left">
			...
			o'clock. There are some critical spots that require careful riding. It is recommended to try
			out the course in advance. The race course is mostly one-way, but there are also a few
			passages with two-way traffic. Keep to the track directions. No riding in the opposite
			direction! Do not ride on the grass.

			<br /> <br />

			<div class="text-theme-1">
				The race will take place in a residential area with a lot of pedestrians. We will try our
				best to keep the race track clear. Stay on the street and do not ride on the pavement unless
				it is marked as such. Be considerate when people are on the route. A checkpoint is located
				outside of the racecourse. You will reach this checkpoint in open traffic. Normal traffic
				rules apply. Be considerate of other road users.
			</div>
		</h2>
	</div>
{/if}
