...
export const registrationSchema = z.object({
    ...
    nick_name:
        z.string()
            ...
            .max(
                64, {message: 'Nickname must be be shorter than 64 characters'})
            .trim()
            .optional(),
    email:
        z.string({required_error: 'First name is required'})
    ...
    race_number:
            z.coerce.number({
                required_error:
                    'A Race Number is required for all participants',
    ...
    additional_comments:
        z.string()
            ...
            .max(2000, {
                message:
                    'Your comments should not be exceed than 2000 characters'
            })
            .trim()
            .optional()
});
